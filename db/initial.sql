...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 23, 2014 at 11:59 AM
...
(1, 'Default Site', 'default', 'localhost', 1, 1408786656, 0);
...
(1, 'ptnhuan@gmail.com', '27e5a3081d47e297d9de0159a62da4ee1abd9cac', '5c419', 1, '', 1, '', 1408786653, 1408786653, 'admin', NULL, NULL);
...
('6187511765f4c46b177de93274aa5bef', '127.0.0.1', 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/36.0.1985.143 Safari/537.36', 1408780689, 'a:6:{s:8:"username";s:5:"admin";s:5:"email";s:17:"ptnhuan@gmail.com";s:2:"id";s:1:"1";s:7:"user_id";s:1:"1";s:8:"group_id";s:1:"1";s:5:"group";s:5:"admin";}');
...
(1, '2014-08-23 11:37:59', NULL, 1, NULL, '<p>Welcome to our homepage. We have not quite finished setting up our website yet, but please add us to your bookmarks and come back soon.</p>'),
(2, '2014-08-23 11:37:59', NULL, 1, NULL, '<p>To contact us please fill out the form below.</p>\n				{{ contact:form name="text|required" email="text|required|valid_email" subject="dropdown|Support|Sales|Feedback|Other" message="textarea" attachment="file|zip" }}\n					<div><label for="name">Name:</label>{{ name }}</div>\n					<div><label for="email">Email:</label>{{ email }}</div>\n					<div><label for="subject">Subject:</label>{{ subject }}</div>\n					<div><label for="message">Message:</label>{{ message }}</div>\n					<div><label for="attachment">Attach  a zip file:</label>{{ attachment }}</div>\n				{{ /contact:form }}'),
(3, '2014-08-23 11:37:59', NULL, 1, NULL, '{{ search:form class="search-form" }} \n		<input name="q" placeholder="Search terms..." />\n	{{ /search:form }}'),
(4, '2014-08-23 11:37:59', NULL, 1, NULL, '{{ search:form class="search-form" }} \n		<input name="q" placeholder="Search terms..." />\n	{{ /search:form }}\n\n{{ search:results }}\n\n	{{ total }} results for "{{ query }}".\n\n	<hr />\n\n	{{ entries }}\n\n		<article>\n			<h4>{{ singular }}: <a href="{{ url }}">{{ title }}</a></h4>\n			<p>{{ description }}</p>\n		</article>\n\n	{{ /entries }}\n\n        {{ pagination }}\n\n{{ /search:results }}'),
(5, '2014-08-23 11:37:59', NULL, 1, NULL, '<p>We cannot find the page you are looking for, please click <a title="Home" href="{{ pages:url id=''1'' }}">here</a> to go to the homepage.</p>');
...
(1, 'home', '', 'Home', 'home', 0, '1', '1', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1408786681, 0, '', 1, 1, 1408786681),
(2, 'contact', '', 'Contact', 'contact', 0, '1', '2', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1408786681, 0, '', 0, 1, 1408786681),
(3, 'search', '', 'Search', 'search', 0, '1', '3', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1408786681, 0, '', 0, 1, 1408786681),
(4, 'results', '', 'Results', 'search/results', 3, '1', '4', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1408786681, 0, '', 0, 0, 1408786681),
(5, '404', '', 'Page missing', '404', 0, '1', '5', NULL, NULL, NULL, '', NULL, NULL, NULL, 0, 0, 'live', 1408786681, 0, '', 0, 1, 1408786681);
...
(1, NULL, NULL, NULL, NULL, 1, 'iTDC TeamPHP', 'iTDC', 'TeamPHP', '', 'en', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
('contact_email', 'Contact E-mail', 'All e-mails from users, guests and the site will go to this e-mail address.', 'text', 'ptnhuan@gmail.com', '', '', 1, 1, 'email', 979),
...
(1, 'ptnhuan@gmail.com', '27e5a3081d47e297d9de0159a62da4ee1abd9cac', '5c419', 1, '', 1, '', 1408786653, 1408780703, 'admin', NULL, NULL);
