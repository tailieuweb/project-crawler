...
abstract class Excel{
   ...
   /**
     ...
     */
   public function push_Data_Excel($data_array = NULL, $rowstart = 1, $customize = 0) {
        $baseRow = $rowstart;
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('A1')->fromArray(array_keys($data_array[0]));
    ...
    public function push_Data_temp_2_Excel($data_array = NULL, $rowstart = 1, $customize = 0) {
        $baseRow = $rowstart;
        $objPHPExcel = $this->objPHPExcel;
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('B1',"Dữ Liệu Nghành:***");
...
//        }
        ...
        //set background color 
         ...
         //set wrap text 
         $objPHPExcel->getActiveSheet()->getStyle('D3:E999')->getAlignment()->setWrapText(true);
         
         //set col text-center
          $objPHPExcel->getActiveSheet()->getStyle('B3:B999')->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
          $objPHPExcel->getActiveSheet()->getStyle('B3:B999')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
          $objPHPExcel->getActiveSheet()->getStyle('C3:C999')->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
          $objPHPExcel->getActiveSheet()->getStyle('C3:C999')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
          $objPHPExcel->getActiveSheet()->getStyle('F3:F999')->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
          $objPHPExcel->getActiveSheet()->getStyle('F3:F999')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
          $objPHPExcel->getActiveSheet()->getStyle('G3:G999')->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
          $objPHPExcel->getActiveSheet()->getStyle('G3:G999')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
          $objPHPExcel->getActiveSheet()->getStyle('H3:H999')->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
          $objPHPExcel->getActiveSheet()->getStyle('H3:H999')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_LEFT);
          
         
          //Format d-y-m col F
          $objPHPExcel->getActiveSheet()->getStyle('F3:F999')->getNumberFormat()->setFormatCode('dd/mm/yyyy');
        ...
        $objPHPExcel->getActiveSheet()->setTitle('dd-mm-yyyy');
        $objPHPExcel->setActiveSheetIndex(0);
        return $this->objPHPExcel = $objPHPExcel;
    }
    /**
