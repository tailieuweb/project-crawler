...
<div class="tabs">
	...
	<div class="form_inputs" id="blog-custom-fields">
		<fieldset>
			<ul>
                            <li class="">
                                    <label for="id_company">Company <span>*</span></label>
                                    <div class="input">
                                        <?php echo form_dropdown('id_company', $companies, isset($post->id_company)?$post->id_company:0) ?>
                                        <a href="admin/contents/company/create">Add new company</a>
                                    </div>
                            </li>
                            
                            <li class="">
                                    <label for="id_work_category">Categories <span>*</span></label>
                                    <div class="input">
                                        <?php echo form_multiselect('id_work_category[]', $work_categories, isset($post->id_work_categories)?explode(',',$post->id_work_categories):0) ?>
                                        <a href="admin/contents/categories/create">Add new category</a>
                                    </div>
                            </li>
