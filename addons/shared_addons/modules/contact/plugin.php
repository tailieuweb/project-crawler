    ...
    public function form() {
        ...
        foreach ($form_meta as $form => $value) {
            ...
            if ($value['type'] == 'dropdown') {
                $parse_data[$form] .= call_user_func('form_' . $value['type'], $form, $form_meta[$form]['dropdown'], set_value($form), 'id="contact_' . $form . '" class="' . $form . '"'
                );
            } elseif ($value['type'] == 'hidden') {
                $parse_data[$form] .= call_user_func('form_' . $value['type'], $form, $value['value'], 'class="' . $form . '"'
                );
            } else {
                $parse_data[$form] .= call_user_func('form_' . $value['type'], $form, set_value($form), 'id="contact_' . $form . '" class="' . $form . '"'
                );
            }
        }
