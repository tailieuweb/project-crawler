...
(function (e) {
    ...
    e.fn.display = function (t) {
        ...
        return this.each(function () {
            ...
            n.center = function (a) {
                var t, r;
                if (n.outerHeight() + 25 > e(window).height() && s === true && o === false && a===true) {
                    var i = e(window).height() - 50;
                    n.css({height: i + "px"})
                }
                n.css({top: 0, left: 0});
                t = Math.max(e(window).height() - n.outerHeight(), 0) / 2;
                r = Math.max(e(window).width() - n.outerWidth(), 0) / 5;
                n.css({top: 0, left: r + e(window).scrollLeft(), right: r + e(window).scrollLeft()});
